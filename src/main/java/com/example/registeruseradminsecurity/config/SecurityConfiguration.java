package com.example.registeruseradminsecurity.config;
...
import com.example.registeruseradminsecurity.filter.JwtAuthFilter;
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(
                        authorizeRequests -> authorizeRequests
                                ...
                                .hasAnyRole(SecurityConstants.USER, SecurityConstants.ADMIN)
